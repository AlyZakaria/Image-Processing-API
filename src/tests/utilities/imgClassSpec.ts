...
describe('Test Image Class ', () => {
    ...
    describe('Image has been resized', () => {
        it('Image has been resized with (500,500)', () => {
            let img = new image(500, 500, 'pyramid', 'JPG')
